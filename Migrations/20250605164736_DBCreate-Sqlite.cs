...
{
    /// <inheritdoc />
    public partial class DBCreateSqlite : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Checklists_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OldPasswordId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPassword", x => x.OldPasswordId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tasks_Checklists_ChecklistId",
